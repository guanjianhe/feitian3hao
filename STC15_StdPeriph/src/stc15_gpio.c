...
/* ****************************************************************************
 * 函数名称：GPIO_Inilize()
 * 入口参数：GPIO(端口号：0~7)，*GPIOx（工作模式和位选择）
 * 出口参数：函数操作返回值（成功返回0, 空操作返回1,错误返回2）
 * 函数功能：初始化普通端口
**************************************************************************** */
uint8 GPIO_Init(uint8 GPIO, GPIO_InitTypeDef *GPIOx)
{
...
**************************************************************************** */
uint8 GPIO_PWMInit(uint8 GPIO_PWM, uint8 PuHzOdPp)
{
